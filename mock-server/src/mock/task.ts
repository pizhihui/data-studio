...
export const tasks = [
  {
    ...
    response() {
      return {
        ...
        "data": {
          "taskID": 753,
          "execID": "exec_id018028linkis-cg-entrancehadoop01:9104IDE_hadoop_jdbc_0"
        }
      }
    }
  },
  {
    // ?taskID=753
    // /api/rest_j/v1/entrance/exec_id018028linkis-cg-entrancehadoop01:9104IDE_hadoop_jdbc_0/status
    url: '/api/rest_j/v1/entrance/:id/status',
    method: 'get',
    response() {
      return {
        "method": "/api/entrance/exec_id018028linkis-cg-entrancehadoop01:9104IDE_hadoop_jdbc_0/status",
        "status": 0,
        "message": "OK",
        "data": {
          "status": "Running",
  ...
  {
    // {"path":"file:///data/linkis/users/hadoop/444.jdbc","scriptContent":"select * from  znzz_pipi_ads.t_table_0_xxxx\nwhere dt='2024-09-05' limit 10","params":{"variable":{},"configuration":{"runtime":{"wds.linkis.engine.runtime.datasource":"库01"}}}}
    ...
    response() {
      return {
        ...
        "data": {
          "task": {
            "taskID": 753,
            "instance": "hadoop01:9104",
            "execId": "IDE_hadoop_jdbc_0",
            "umUser": "hadoop",
            "executeUser": "hadoop",
            "engineInstance": "hadoop01:32792",
            ...
            "runType": "jdbc",
            "paramsJson": "{\"configuration\":{\"special\":{},\"runtime\":{\"wds.linkis.engine.runtime.datasource\":\"库01\",\"source\":{\"scriptPath\":\"file:///data/linkis/users/hadoop/333.jdbc\",\"requestIP\":\"61.144.186.159\"},\"jobId\":\"753\",\"job\":{\"#rt_rs_store_path\":\"file:///data/linkis/result/2024-09-23/IDE/hadoop/753\"}},\"startup\":{\"jobId\":\"753\"}},\"variable\":{}}",
            "costTime": 5000,
            "strongerExecId": "exec_id018028linkis-cg-entrancehadoop01:9104IDE_hadoop_jdbc_0",
  ...
  {
    // ?fromLine=1&size=-1
    // /api/rest_j/v1/entrance/exec_id018028linkis-cg-entrancehadoop01:9104IDE_hadoop_jdbc_0/log
    url: '/api/rest_j/v1/entrance/:id/log',
    method: 'get',
    response() {
      return {
        "method": "/api/entrance/exec_id018028linkis-cg-entrancehadoop01:9104IDE_hadoop_jdbc_0/log",
        "status": 0,
        "message": "OK",
        "data": {
          "fromLine": 33,
