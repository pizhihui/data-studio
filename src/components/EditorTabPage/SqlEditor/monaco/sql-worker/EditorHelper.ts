import {SupportLanguage} from "@/components/EditorTabPage/SqlEditor/monaco/sql-worker/supportLanguage";
import {Databases } from "@/services";
import { Query } from "@/services/types/query";
import * as monaco from 'monaco-editor';
import { LanguageWorker } from './LanguageWorker';
import CommonSQL from "@/components/EditorTabPage/SqlEditor/monaco/sql-worker/grammar/CommonSQL";
...
export class EditorHelper {
  ...
  private serverStructure?: Databases.Server;
  ...
  public applyServerStructure(serverStructure: Databases.Server, thisMonaco: tMonaco): void {
